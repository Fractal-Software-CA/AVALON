...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 28 04:36:48 2022
...
def cruce1_entidades_Output_investigadores(spark,
                                           ...
                                           Flag_csv = True):
    '''
    Esta función almacena en la rutas establecidas los archivos correspondientes a Nombre_Intermedio_cruce1_entidades
    y Nombre_Output_investigadores
    Parameters
    ----------
    spark : SPARK SESSION
        Variable que contiene la sesión de Spark.
    Ruta_Nombre_Input_entidades : STRING
        Ruta del fichero Nombre_Input_entidades.
    Ruta_Nombre_Input_investigadores : STRING
        Ruta del fichero Nombre_Input_investigadores.
    Ruta_Nombre_Input_relaciones : STRING
        Ruta del fichero Nombre_Input_relaciones.
    Ruta_Nombre_Intermedio_cruce1_entidades : STRING
        Ruta del fichero Nombre_Intermedio_cruce1_entidades.
    Ruta_Nombre_Output_investigadores : STRING
        Ruta del fichero Nombre_Output_investigadores.
    Flag_csv : BOOLEAN, optional
        Valor utilizado para definir si se desea guardar solo en csv y/o parquet . The default is True.

    Returns
    -------
    data : SPARK DATAFRAME.
    Nombre_Input_relaciones : SPARK DATAFRAME
    Nombre_Input_investigadores : SPARK DATAFRAME
    Nombre_Intermedio_cruce1_entidades : SPARK DATAFRAME
    Nombre_Output_investigadores : SPARK DATAFRAME
    ...
    # =============================================================================
    # Procesamiento para iniciar el archivo deseado a partir del maxId
    # =============================================================================
    ...
    print(f'Almacenando fichero en la ruta {Ruta_Nombre_Intermedio_cruce1_entidades}')
    # =============================================================================
    ...
    print(f'Almacenando fichero en la ruta {Ruta_Nombre_Output_investigadores}')
    # =============================================================================
    # Aplicación de metodo para almacenar el resultado (parquet, csv, o ambos inclusive)
    # =============================================================================
    save_csv_parquet(Nombre_Output_investigadores, Flag_csv, Ruta_Nombre_Output_investigadores)
    return data,Nombre_Input_relaciones, Nombre_Input_entidades, Nombre_Input_investigadores, Nombre_Intermedio_cruce1_entidades, Nombre_Output_investigadores
    
def cruce1_relaciones(spark,
                      data,
                      ...
                      Flag_csv):
    '''
    Esta función alamacena y procesa los archivos correspondientes a Nombre_Intermedio_cruce1_relaciones
    ...
    Flag_csv : BOOLEAN
        Valor utilizado para almacenar el archivo en csv y/o parquet.

    Returns
    -------
    Nombre_Intermedio_cruce1_relaciones : SPARK DATAFRAME
    ...
    print(f'Almacenando fichero en la ruta {Ruta_Nombre_Intermedio_cruce1_relaciones}')
    # =============================================================================
    # Aplicación de metodo para almacenar el resultado (parquet, csv, o ambos inclusive)
    # =============================================================================
    save_csv_parquet(Nombre_Intermedio_cruce1_relaciones, Flag_csv, Ruta_Nombre_Intermedio_cruce1_relaciones)
    return Nombre_Intermedio_cruce1_relaciones

def output_relaciones(spark,
                      Nombre_Input_relaciones,
                      Nombre_Intermedio_cruce1_relaciones,
                      Ruta_Nombre_Output_relaciones,
                      Flag_csv):
    '''
    Función utilizada para procesar y almacenar los archivos correspondientes a Nombre_Output_relaciones
    ...
    Returns
    -------
    Nombre_Output_relaciones : SPARK DATAFRAME
    ...
    print(f'Almacenando fichero en la ruta {Ruta_Nombre_Output_relaciones}')
    # =============================================================================
    # Aplicación de metodo para almacenar el resultado (parquet, csv, o ambos inclusive)
    # =============================================================================
    save_csv_parquet(Nombre_Output_relaciones, Flag_csv, Ruta_Nombre_Output_relaciones)
    return Nombre_Output_relaciones

def cruce2_invente(spark,
                    ...
                    Flag_csv):
    '''
    Esta función procesa y almacena los archivos correspondientes a Nombre_Intermedio_cruce2_invente

    Parameters
    ----------
    spark : SPARK SESSION
    Nombre_Input_entidades : SPARK DATAFRAME
    ...
    Nombre_Intermedio_cruce2_invente2 = Nombre_Intermedio_cruce2_invente.filter("final_score is  NULL").drop("Entidad_Norm")
    Nombre_Intermedio_cruce2_invente2 = Nombre_Intermedio_cruce2_invente2.withColumn("Entidad_Norm", col("DenominacionSocial_Norm"))\
                                                                        .withColumn("Provincia_Entidad", col("Provincia_Codigo"))\
                                                                        .withColumn("CIF", col("NIF"))\
                                                                        .withColumn("Similitud_invente", col("final_score"))
    Nombre_Intermedio_cruce2_invente2 = Nombre_Intermedio_cruce2_invente2.select(Nombre_Intermedio_cruce1_entidades.columns+["Similitud_invente"])


    Nombre_Intermedio_cruce2_invente = Nombre_Intermedio_cruce2_invente1.union(Nombre_Intermedio_cruce2_invente2)

    print(f'Almacenando fichero en la ruta {Ruta_Nombre_Intermedio_cruce2_invente}')
    # =============================================================================
    # Aplicación de metodo para almacenar el resultado (parquet, csv, o ambos inclusive)
    # =============================================================================
    save_csv_parquet(Nombre_Intermedio_cruce2_invente, Flag_csv, Ruta_Nombre_Intermedio_cruce2_invente)
    return Nombre_Intermedio_cruce2_invente

def cruce3_dir3(spark,
                Nombre_Intermedio_cruce2_invente,
    ...
    '''
    Esta función procesa y almacena el archivo correspondiente a Nombre_Intermedio_cruce3_dir3.

    Parameters
    ----------
    spark : SPARK SESSION
    Nombre_Intermedio_cruce2_invente : SPARK DATAFRAME
    ...
    print(f'Almacenando fichero en la ruta {Ruta_Nombre_Intermedio_cruce3_dir3}')
    # =============================================================================
    # Aplicación de metodo para almacenar el resultado (parquet, csv, o ambos inclusive)
    # =============================================================================
    save_csv_parquet(Nombre_Intermedio_cruce3_dir3, Flag_csv, Ruta_Nombre_Intermedio_cruce3_dir3)
    return Nombre_Intermedio_cruce3_dir3

def Output_entidades_true(spark,
                          Nombre_Input_entidades,
    ...
    Nombre_Output_entidades = Nombre_Input_entidades\
                                                .union(Nombre_Output_entidades.drop("Cruce")
                                                      )

    print(f'Almacenando fichero en la ruta {Ruta_Nombre_Output_entidades}')
    # =============================================================================
    # Aplicación de metodo para almacenar el resultado (parquet, csv, o ambos inclusive)
    # =============================================================================
    save_csv_parquet(Nombre_Output_entidades, Flag_csv, Ruta_Nombre_Output_entidades)
    
def Output_entidades_false(spark,
                          Nombre_Input_entidades,
                          Nombre_Intermedio_cruce1_entidades,
                          Ruta_Nombre_Output_entidades):     
    Nombre_Output_entidades = Nombre_Input_entidades\
