...
def FuncionAzul(Ruta_Nombre_Input_entidades, Ruta_Nombre_Input_investigadores, 
    ...
    Parameters
    ----------
    Ruta_Nombre_Input_entidades : TYPE
        DESCRIPTION.
    Ruta_Nombre_Input_investigadores : TYPE
        DESCRIPTION.
    Ruta_Nombre_Input_relaciones : TYPE
        DESCRIPTION.
    Ruta_Nombre_Input_invente : TYPE
        DESCRIPTION.
    Ruta_Nombre_Input_dir3 : TYPE
        DESCRIPTION.
    Ruta_Nombre_Intermedio_cruce1_relaciones : TYPE
        DESCRIPTION.
    Ruta_Nombre_Intermedio_cruce1_entidades : TYPE
        DESCRIPTION.
    Ruta_Nombre_Intermedio_cruce2_invente : TYPE
        DESCRIPTION.
    Ruta_Nombre_Intermedio_cruce3_dir3 : TYPE
        DESCRIPTION.
    Ruta_Nombre_Output_investigadores : TYPE
        DESCRIPTION.
    Ruta_Nombre_Output_relaciones : TYPE
        DESCRIPTION.
    Ruta_Nombre_Output_entidades : TYPE
        DESCRIPTION.
    flag_invente_dir3 : TYPE
        DESCRIPTION.
    Flag_csv : TYPE
        DESCRIPTION.
